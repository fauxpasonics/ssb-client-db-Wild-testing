...
CREATE VIEW [etl].[vw_Load_DimCustomer_Eloqua]
AS
    ( SELECT    *
	/*Name*/
	, HASHBYTES('sha2_256',
...
--base set
			...
			/*Standard Attributes*/ ,
                            CAST(c.ContactIDExt AS NVARCHAR(25)) [SSID] ,
                            NULL AS [CustomerType] ,
                            NULL AS [CustomerStatus] ,
                            NULL AS [AccountType] ,
                            CAST(c.SalesPerson AS NVARCHAR(50)) AS [AccountRep] ,
                            CAST(c.Company AS NVARCHAR(50)) AS [CompanyName] ,
                            C_Salutation AS [SalutationName] ,
                            NULL AS [DonorMailName] ,
                            NULL AS [DonorFormalName] ,
                            CASE WHEN c.C_Birthdate1 = '1601-01-01' THEN NULL 
								ELSE c.C_Birthdate1 END AS [Birthday] ,
                            NULL AS [Gender] ,
                            0 [MergedRecordFlag] ,
                            NULL [MergedIntoSSID]
			...
			/*AddressPrimary*/ ,
                            Address1 AS [AddressPrimaryStreet] ,
							NULL AS [AddressPrimarySuite] ,
                            City AS [AddressPrimaryCity] ,
                            Province AS [AddressPrimaryState] ,
                            PostalCode AS [AddressPrimaryZip] ,
			...
			/*Phone*/ ,
                            LEFT(C_Direct_Phone1, 25) AS [PhonePrimary] ,
                            LEFT(C_Home_Phone1, 25) AS [PhoneHome] ,
                            LEFT(MobilePhone, 25) AS [PhoneCell] ,
                            LEFT(BusinessPhone, 25) AS [PhoneBusiness] ,
			...
			/*Extended Attributes*/ ,
                            C_MSCRMContactID AS [ExtAttribute1] --nvarchar(100) CRMGUID
                            ,
                            ...
                            C_MSCRMAccountID AS [ExtAttribute11] ,
			...
			/*Source Created and Updated*/ ,
                            ...
                            CreatedAt [SSCreatedDate] ,
                            UpdatedAt [SSUpdatedDate] ,
							ETL_CreatedDate as [CreatedDate] ,
							ETL_UpdatedDate as [UpdatedDate] ,

                            C_MSCRMAccountID [AccountId] ,
                            NULL IsBusiness ,
							0 IsDeleted , 
...
--					select *
					FROM ods.Eloqua_Contact c WITH (NOLOCK)
					WHERE 1 = 1
