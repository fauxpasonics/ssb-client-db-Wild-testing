...
CREATE VIEW [etl].[vw_Load_DimCustomer_DynamicsContacts]
AS
    (
      SELECT    *
	/*Name*/
...
SELECT  DB_NAME() AS [SourceDB]
      , 'Dynamics CRM - Contacts' AS [SourceSystem]
...
/*Standard Attributes*/
      ...
      , NULL AS [AccountType]
      , c.kore_ticketingservicerepname AS [AccountRep]
      , CASE WHEN c.kore_companyname = '' THEN NULL ELSE kore_companyname END AS [CompanyName]
      , c.salutation AS [SalutationName]
      , NULL AS [DonorMailName]
      , NULL AS [DonorFormalName]
      , CAST(c.birthdate as date) AS [Birthday]
      , c.gendercodename AS [Gender]
      , 0 [MergedRecordFlag]
      , NULL [MergedIntoSSID]
...
/*Name*/
      ...
      , c.suffix AS [Suffix]
	  , CASE WHEN c.suffix IS NULL THEN c.fullname ELSE c.fullname + ' ' + c.suffix END AS [Fullname]
...
/*AddressPrimary*/
      ...
      , c.address1_line1 AS [AddressOneStreet]
      , NULL AS [AddressOneSuite]
      , c.address1_city AS [AddressOneCity]
      , c.address1_stateorprovince AS [AddressOneState]
      , c.address1_postalcode AS [AddressOneZip]
      , c.address1_county AS [AddressOneCounty]
      , c.address1_country AS [AddressOneCountry]

      , c.address2_line1 AS [AddressTwoStreet]
      , NULL AS [AddressTwoSuite]
      , c.address2_city AS [AddressTwoCity]
      , c.address2_stateorprovince AS [AddressTwoState]
      , c.address2_postalcode AS [AddressTwoZip]
      , c.address2_county AS [AddressTwoCounty]
      , c.address2_country AS [AddressTwoCountry]
...
/*Phone*/
      , c.telephone1 AS [PhonePrimary]
      , c.telephone2 AS [PhoneHome]
      , c.telephone3 AS [PhoneCell]
      , c.telephone1 AS [PhoneBusiness]
      , NULL AS [PhoneFax]
      , NULL AS [PhoneOther]
...
/*Extended Attributes*/
      ...
      , c.client_primaryaccountholderaccountnumber AS [ExtAttribute11]
...
/*Source Created and Updated*/
      ...
      , c.statecode AS IsDeleted
      , GETDATE() CreatedDate
      , GETDATE() UpdatedDate
      , c.kore_primaryarchticsid [AccountId]
      , 0 IsBusiness
	  , NULL AS customer_matchkey

--		select top 100 *
		FROM Wild_Reporting.prodcopy.Contact AS c WITH ( NOLOCK ) 
		WHERE 1 = 1
