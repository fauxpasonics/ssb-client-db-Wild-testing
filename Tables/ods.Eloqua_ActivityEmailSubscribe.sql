...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__02084FDA] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__02FC7413] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__03F0984C] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityEmailSubscribe] ADD CONSTRAINT [PK__Eloqua_A__3214EC279CE95C06] PRIMARY KEY CLUSTERED  ([ID])
GO
