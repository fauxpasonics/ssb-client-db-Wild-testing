...
GO
ALTER TABLE [ods].[TM_Plans_History] ADD CONSTRAINT [PK__TM_Plans_History] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_PlanKey] ON [ods].[TM_Plans_History] ([acct_id], [plan_event_id], [ticket_status], [section_id], [row_id], [seat_num]) INCLUDE ([num_seats], [ssbPriceCode])
GO
CREATE NONCLUSTERED INDEX [IDX_ticket_status] ON [ods].[TM_Plans_History] ([ticket_status])
GO
CREATE NONCLUSTERED INDEX [IDX_UpdateDate] ON [ods].[TM_Plans_History] ([UpdateDate])
GO
