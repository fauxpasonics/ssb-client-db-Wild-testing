CREATE TABLE [segmentation].[SegmentationFlatDatafa45217a-e34b-40d1-b8e0-0503fdf6a605]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatafa45217a-e34b-40d1-b8e0-0503fdf6a605] ADD CONSTRAINT [pk_SegmentationFlatDatafa45217a-e34b-40d1-b8e0-0503fdf6a605] PRIMARY KEY NONCLUSTERED  ([id])
GO
