CREATE TABLE [segmentation].[SegmentationFlatDatabf917478-56fd-4219-95cb-a5e3190a7556]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatabf917478-56fd-4219-95cb-a5e3190a7556] ADD CONSTRAINT [pk_SegmentationFlatDatabf917478-56fd-4219-95cb-a5e3190a7556] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDatabf917478-56fd-4219-95cb-a5e3190a7556] ON [segmentation].[SegmentationFlatDatabf917478-56fd-4219-95cb-a5e3190a7556] ([_rn])
GO
