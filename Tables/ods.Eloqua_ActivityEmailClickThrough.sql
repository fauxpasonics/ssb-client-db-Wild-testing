...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__7D439ABD] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__7E37BEF6] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__7F2BE32F] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityEmailClickThrough] ADD CONSTRAINT [PK__Eloqua_A__3214EC275840065E] PRIMARY KEY CLUSTERED  ([ID])
GO
