...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__19DFD96B] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__1AD3FDA4] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__1BC821DD] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityEmailUnsubscribe] ADD CONSTRAINT [PK__Eloqua_A__3214EC279067BC2E] PRIMARY KEY CLUSTERED  ([ID])
GO
