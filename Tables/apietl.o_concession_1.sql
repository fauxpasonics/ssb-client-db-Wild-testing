CREATE TABLE [apietl].[o_concession_1]
(
[o_concession_id] [uniqueidentifier] NOT NULL,
...
GO
ALTER TABLE [apietl].[o_concession_1] ADD CONSTRAINT [PK__o_conces__ECB920608FA41CD4] PRIMARY KEY CLUSTERED  ([o_concession_id])
GO
