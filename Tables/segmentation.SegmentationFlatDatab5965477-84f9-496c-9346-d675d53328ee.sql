CREATE TABLE [segmentation].[SegmentationFlatDatab5965477-84f9-496c-9346-d675d53328ee]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatab5965477-84f9-496c-9346-d675d53328ee] ADD CONSTRAINT [pk_SegmentationFlatDatab5965477-84f9-496c-9346-d675d53328ee] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDatab5965477-84f9-496c-9346-d675d53328ee] ON [segmentation].[SegmentationFlatDatab5965477-84f9-496c-9346-d675d53328ee] ([_rn])
GO
