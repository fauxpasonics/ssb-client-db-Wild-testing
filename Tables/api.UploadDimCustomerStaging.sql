...
[RecordCreateDate] [datetime] NULL CONSTRAINT [DF__UploadDim__Recor__0880433F] DEFAULT (getdate()),
[Processed] [bit] NULL CONSTRAINT [DF__UploadDim__Proce__09746778] DEFAULT ((0)),
...
[IsDeleted] [bit] NULL CONSTRAINT [DF__UploadDim__IsDel__41B8C09B] DEFAULT ((0))
)
GO
