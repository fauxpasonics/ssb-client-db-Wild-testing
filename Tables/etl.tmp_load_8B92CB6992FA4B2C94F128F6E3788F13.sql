CREATE TABLE [etl].[tmp_load_8B92CB6992FA4B2C94F128F6E3788F13]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_8B92CB6992FA4B2C94F128F6E3788F13_ss] ON [etl].[tmp_load_8B92CB6992FA4B2C94F128F6E3788F13] ([SourceSystem], [SSID])
GO
