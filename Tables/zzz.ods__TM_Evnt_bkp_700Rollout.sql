...
[Season_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Evnt__InsertD__4E53A1AA] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Evnt__UpdateD__4F47C5E3] DEFAULT (getdate()),
