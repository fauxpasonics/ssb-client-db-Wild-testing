CREATE TABLE [segmentation].[SegmentationFlatDatae268cee7-0955-4211-aac1-5d79f3dfef4b]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatae268cee7-0955-4211-aac1-5d79f3dfef4b] ADD CONSTRAINT [pk_SegmentationFlatDatae268cee7-0955-4211-aac1-5d79f3dfef4b] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDatae268cee7-0955-4211-aac1-5d79f3dfef4b] ON [segmentation].[SegmentationFlatDatae268cee7-0955-4211-aac1-5d79f3dfef4b] ([_rn])
GO
