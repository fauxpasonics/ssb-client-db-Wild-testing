...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_C__741BB9E4] DEFAULT (getdate()),
[ID] [int] NOT NULL,
...
GO
ALTER TABLE [src].[Eloqua_EmailGroup] ADD CONSTRAINT [PK__Eloqua_E__3214EC27A7DEB73F] PRIMARY KEY CLUSTERED  ([ID])
GO
