...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__InsertD__2DB1C7EE] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__UpdateD__2EA5EC27] DEFAULT (getdate()),
