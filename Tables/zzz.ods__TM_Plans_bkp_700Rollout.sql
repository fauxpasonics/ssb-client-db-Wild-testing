...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Insert__18B6AB08] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Update__19AACF41] DEFAULT (getdate()),
