...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ca__ETL_C__67B5E2FF] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ca__ETL_U__68AA0738] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ca__ETL_I__699E2B71] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_Campaign] ADD CONSTRAINT [PK__Eloqua_C__3214EC27ED04070A] PRIMARY KEY CLUSTERED  ([ID])
GO
