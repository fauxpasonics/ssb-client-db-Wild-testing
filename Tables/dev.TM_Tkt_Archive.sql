CREATE TABLE [dev].[TM_Tkt_Archive]
(
...
GO
CREATE NONCLUSTERED INDEX [IDX_acct_id] ON [dev].[TM_Tkt_Archive] ([acct_id])
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [dev].[TM_Tkt_Archive] ([CreatedDate])
GO
