...
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer__IsDeleted__Covers] ON [dbo].[DimCustomer] ([IsDeleted]) INCLUDE ([AddressPrimaryIsCleanStatus], [EmailPrimaryIsCleanStatus], [PhonePrimaryIsCleanStatus], [SourceSystem], [UpdatedDate])
GO
