...
CREATE PROCEDURE [etl].[FactAttendance_UpdateAttendanceAPI]
...
BEGIN
	...
	INTO #AttendData
	FROM (
		SELECT acct_id, event_id, section_id, row_id, seat_num, gate, (CAST(a.event_date AS DATETIME) + ISNULL(TRY_CAST(a.action_time AS DATETIME), '00:00')) scan_date
